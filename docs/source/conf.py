...
html_theme_options = {
  ...
  # remote file)
  'cssfiles': ['https://maxcdn.bootstrapcdn.com/bootstrap/3.3.6/css/bootstrap.min.css', '_static/custom.css'],  # default is empty list , '_static/my_style.css'
